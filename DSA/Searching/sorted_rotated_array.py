...
# if it's higher, we will run a reverse loop and start from end till we find match or
# element which is lower than lookup value else, do similar expression but using a normal loop
